...
export default function TaskCard({ task, onUpdate, onDelete, isDragging =false }: TaskCardProps) {
    ...
    if(isSortableDragging || isDragging){
     ...
     return(
            <>
            <Card ref={setNodeRef} style={style} className={`relative cursor-pointer transition-all hover:shadow-md ${isOverDue ? "border-red-200 dark:border-red-800" : ""}`}{...attributes} {...listeners}>
            <Button 
                variant="ghost" 
                size="icon" 
                className="absolute top-0 right-0 w-6 h-6 mx-2" 
                            ...
                            {/* <div className="flex items-center gap-1">
                                ...
                                {/* <DropdownMenu>
                                    ...
                                    <DropdownMenuContent asChild>
                                        ...
                                        <DropdownMenuItem onClick={() => onDelete(task.id as string)} className="text-red-600 dark:text-red-400">
                                            Delete
                                        </DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu> */}
